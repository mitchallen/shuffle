> **This repository is archived, and `@mitchallen/shuffle` is frozen at 0.1.17.**
...
> `@mitchallen/shuffle-v2`, an internal package of the
> [maze-generator-v2](https://github.com/mitchallen/maze-generator-v2) monorepo
> ([`packages/shuffle`](https://github.com/mitchallen/maze-generator-v2/tree/main/packages/shuffle)),
> bundled into `@mitchallen/maze-generator-v2`. Version 0.1.17 was published from
...
<p align="left">
  ...
  <a href="https://github.com/mitchallen/shuffle/actions/workflows/ci.yml?query=branch%3Amain">
